var Build = (function() {
    ...
    var HotkeyModel = function() {
        ...
        self.SpecIdToGridMap = ko.observable(
            {
                "/pa/units/land/titan_structure/titan_structure.json": ["utility", 7],
                "/pa/units/land/control_module/control_module.json": ["utility", 12],
                "/pa/units/land/radar_adv/radar_adv.json": ["utility", 14],
		"/pa/units/sea/sonar_adv/sonar_adv.json": ["utility", 9],
                ...
                "/pa/units/orbital/delta_v_engine/delta_v_engine.json": ["utility", 13],
		...
		"/pa/units/sea/sonar/sonar.json": ["utility", 21],
                ...
                "/pa/units/land/land_barrier/land_barrier.json": ["utility", 18],
		"/pa/units/orbital/deep_space_radar/deep_space_radar.json": ["utility", 8],
                "/pa/units/land/teleporter/teleporter.json": ["utility", 19],
                "/pa/units/orbital/deep_space_radar_basic/deep_space_radar_basic.json": ["utility", 15],
		...
		"/pa/units/sea/battleship/battleship.json": ["factory", 8],
                ...
                "/pa/units/land/unit_cannon/unit_cannon.json": ["factory", 12],
				"/pa/units/land/artillery_unit_launcher/artillery_unit_launcher.json": ["factory", 18],
		...
		"/pa/units/land/laser_defense_sniper/laser_defense_sniper.json": ["combat", 10],
                "/pa/units/land/artillery_long/artillery_long.json": ["combat", 9],
                "/pa/units/land/tactical_missile_launcher/tactical_missile_launcher.json": ["combat", 12],
                "/pa/units/land/nuke_launcher/nuke_launcher.json": ["combat", 6],
                "/pa/units/land/laser_defense/laser_defense.json": ["combat", 13],
                ...
                "/pa/units/land/laser_defense_single/laser_defense_single.json": ["combat", 19],
		...
		"/pa/units/land/rocket_defense/rocket_defense.json": ["combat", 20],
                ...
                "/pa/units/sea/torpedo_launcher/torpedo_launcher.json": ["combat", 21],
		...
		"/pa/units/land/hover_artillery/hover_artillery.json": ["vehicleadv", 21],
                ...
                "/pa/units/land/tank_heavy_armor/tank_heavy_armor.json": ["vehicle", 14],
                "/pa/units/land/land_scout/land_scout.json": ["vehicle", 19],
		"/pa/units/land/tank_attack/tank_attack.json": ["vehicle", 20],
                "/pa/units/land/aa_missile_vehicle/aa_missile_vehicle.json": ["vehicle", 16],
		"/pa/units/land/hover_aa/hover_aa.json": ["vehicle", 22],
		"/pa/units/land/tank_heavy_artillery/tank_heavy_artillery.json": ["vehicle", 23],
                "/pa/units/land/tank_hover/tank_hover.json": ["vehicle", 21],


                "/pa/units/land/bot_support_commander/bot_support_commander.json": ["botadv", 12],
		"/pa/units/land/bot_ubercannon/bot_ubercannon.json": ["botadv", 14],
		"/pa/units/land/raptor_bot_1/raptor_bot_1.json": ["botadv", 15],
		"/pa/units/land/bot_orbital/bot_orbital.json": ["botadv", 16],
                "/pa/units/land/bot_nanoswarm/bot_nanoswarm.json": ["botadv", 13],           
		...
		"/pa/units/land/bot_raider/bot_raider.json": ["bot", 19],
		"/pa/units/land/amphibious_fabricator/amphibious_fabricator.json": ["bot", 12],
		...
		"/pa/units/land/bot_mortar/bot_mortar.json": ["bot", 15],
                ...
                "/pa/units/land/bot_tesla/bot_tesla.json": ["bot", 20],
				...
				"/pa/units/air/bomber_naval/bomber_naval.json": ["airadv", 22],
                "/pa/units/air/support_platform/support_platform.json": ["airadv", 23],
                "/pa/units/air/bomber_adv/bomber_adv.json": ["airadv", 21],
                "/pa/units/air/bomber_heavy/bomber_heavy.json": ["airadv", 20],
 
                "/pa/units/air/fabrication_aircraft/fabrication_aircraft.json": ["air", 18],
                "/pa/units/air/fighter/fighter.json": ["air", 20],
		"/pa/units/air/fighter_beam/fighter_beam.json": ["air", 14],
                "/pa/units/air/bomber/bomber.json": ["air", 21],
                "/pa/units/air/air_scout/air_scout.json": ["air", 19],
				"/pa/units/air/gunship/gunship.json": ["air", 13],
                "/pa/units/air/transport/transport.json": ["air", 23],
                "/pa/units/air/solar_drone/solar_drone.json": ["air", 22],
		...
		"/pa/units/sea/fabrication_sub/fabrication_sub.json": ["sea", 23],
                ...
                "/pa/units/orbital/orbital_fighter/orbital_fighter.json": ["orbital", 14],
                "/pa/units/orbital/radar_satellite/radar_satellite.json": ["orbital", 13],
